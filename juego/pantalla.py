...
from juego import ANCHO, ALTO, BLANCO, FPS, NEGRO, WIN, MAX_PARTIDA, RELOJ
...
class Partida:
    ...
    def __init__(self, pantalla, tiempo):
        ...
        self.nave.vida = pg.image.load("juego/imagenes/vida.png")
